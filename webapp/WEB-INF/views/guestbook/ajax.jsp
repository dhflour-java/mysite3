...
<body>
	<div id="container">
		...
		<div id="content">
				...
				<form id="add-form" action="" method="get">
					<table>
						<tr>
							...
							<td>비밀번호</td><td><input type="password" id="input-password" name="password"></td>
						</tr>
						<tr>
							<td colspan=4><textarea name="contents" id="ta-contents" cols="70" rows="5"></textarea></td>
						</tr>
						<tr>
			...
			<div id="dialog-form" title="글삭제" style="display:none">
			  <p class="validateTips normal" style="margin-bottom:10px">
				작성시 작성했던 비밀번호를 입력 하세요.
			  </p>
			  <p class="validateTips error" style="margin-bottom:10px; display:none">
				틀린 비밀번호 입니다. 
			  </p>
			  <form>
